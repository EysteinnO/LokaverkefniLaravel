...
<link href="{{ URL::asset('/css/fullcalendar.min.css') }}" rel="stylesheet" media='print' />
...
<script>
  ...
  $(document).ready(function() {
    ...
    $('#calendar').fullCalendar({
      ...
      //Hér þarf að bæta við falli sem populate'ar þennan array af gögnum úr SQL Database
...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/schedule">Your schedule</a>
          </li>
          <li class="nav-item">
  ...
  <div class="jumbotron">
    ...
    <div  class="container">      
       <h1 class="title"> Your personal calendar </h1>
      <div id='calendar'></div>
    </div>
  </div>
</body>
